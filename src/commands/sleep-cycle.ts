...
import { executeDreamPass } from "../sleep/index.js";
import { rollbackChange, rollbackRun } from "../sleep/rollback.js";
  ...
  private async handleStatus(
    ...
    if (!settings) {
      ...
      lines.push(
        ...
        `**Last run**: ${settings.lastRunAt?.toISOString() ?? "never"} · **Next eligible**: ${settings.nextEligibleAt.toISOString()}`
      );
    }
